...
class DemoGigaPlugin : GigaPlugin {
    companion object {
        private const val DEMO_CHANNEL = "gigasoft-demo:events"
    }
    ...
    private val delegate = gigaPlugin(
        ...
        textures {
            texture(
                ...
                path = "assets/gigasoft-demo/textures/block/demo_crusher_side.png",
                category = "block"
            )
        }
        ...
        models {
            model(
                ...
                geometryPath = "assets/gigasoft-demo/models/block/demo_crusher.json",
                textures = mapOf("side" to "demo_crusher_side"),
                animations = mapOf("spin" to "assets/gigasoft-demo/animations/demo_crusher_spin.json")
            )
        }
        ...
        animations {
            animation(
                ...
                path = "assets/gigasoft-demo/animations/demo_crusher_spin.json",
        ...
        sounds {
            sound(
                id = "demo_crusher_hum",
                path = "assets/gigasoft-demo/sounds/demo_crusher_hum.ogg",
                category = "block",
                stream = false
            )
        }
        ...
        commands {
            ...
            spec(
                ...
                val text = collectTail(inv.rawArgs, fromIndex = 2).ifBlank { "Hello from GigaSoft Demo" }
