# GigaSoft API v1.0.0 (Frozen Contract)
...
This version freezes these public contracts from `gigasoft-api`:
...
Host access is permission-gated. Plugins must declare required host permissions in `gigaplugin.yml`.
